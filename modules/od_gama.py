...
class OD_Indicator(CS.Mobility_indicator):
    ...
    def return_indicator(self, geogrid_data):
        ...
        od_output=self.simulate(sample_simpop_df)
...
od=OD_Indicator(zones, geogrid, table_name, simpop_df, mob_sys,
